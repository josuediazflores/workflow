 ...
 *
 * `grep -c 'testJsOnly\|describeJsOnly'` is the size of that exclusion; every
 * other test is in scope for cross-language conformance and is gated only by
 * `e2e-conformance.json`. No-op for the JS workbench apps.
 */
